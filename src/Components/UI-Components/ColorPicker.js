import { Box, Button, InputLabel, Slider, Typography } from "@mui/material";
      ...
      {!closed && (
        <Box
          sx={{
            ...
            gridAutoFlow: "column",
            "&:hover": {
              background: "linear-gradient(90deg,#e66465, 10%, #9198e5)",
              borderRadius: "10px",
            },
          }}
        >
          ...
          >
            ...
            >
              ...
              <Button
                ...
                onClick={() => (closed ? setClosed(false) : setClosed(true))}
              >
                Close
              </Button>
            </Box>
