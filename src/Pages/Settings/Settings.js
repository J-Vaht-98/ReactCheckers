...
function Settings(props) {
  ...
  function handleSaveSettings() {
    ...
    window.localStorage.setItem("checkersSettings", JSON.stringify(settings));
  }
    ...
    <>
      ...
      {props.showColorSettings && (
        <Box>
          <OptionBox>
            <ColorPicker
              onChange={(val) => handleColorChange("blackSquare", val)}
          ...
          <OptionBox>
            <ColorPicker
              onChange={(val) => handleColorChange("whiteSquare", val)}
